...
// 은주는 놀이공원 아르바이트를 하고 있다. 은주가 일하는 놀이공원에서는 현재 놀이공원 곳곳에 숨겨진 숫자 스탬프를 모아오면 선물을 주는 이벤트를 하고 있다. 숫자 스탬프는 매일 그 수에 적힌 숫자가 바뀌지만 그 숫자는 항상 연속된다.
...
function isConsecutiveNumber(nums) {
  let arr = nums.split(" ").sort((a, b) => a - b);
